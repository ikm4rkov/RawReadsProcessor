                    ...
                    if (success == 1 && DNA_Length_Success && RNA_Length_Success) {
                        ...
                        if (success == 1 && DNA_Length_Success && RNA_Length_Success) {
                            ...
                            if (TSVu == 1) {
                                ...
                                count_SE_codes["BF" + std::to_string(RNA_Length_Success) + std::to_string(success) + std::to_string(DNA_Length_Success)] += 1;
                                                                                                                                brstart = 0;
                                brend = 0;
                                print1f_types(types, types0, typesbuffer);
                                types0 = "";
                ...
                if (success1F + success1R + success2F + success2R == 1) {
                    ...
                    if (RNA_Length_Success && DNA_Length_Success) {
                        if (success1F == 1) {
                            ...
                            if (TSVu == 1) {
                                types0 = dna_read[0] +  "\tBT\t1101\t" + std::to_string(brstart) + "\t" + std::to_string(brend) + "\n";
                                count_PE_codes["BT1101"] += 1;
                                                                                                                                brstart = 0;
                                brend = 0;
                                print1f_types(types, types0, typesbuffer);
                                types0 = "";
                        ...
                        if (success1R == 1) {
                            ...
                            if (TSVu == 1) {
                                types0 = dna_read[0] +  "\tBT\t1201\t" + std::to_string(brstart) + "\t" + std::to_string(brend) + "\n";
                                count_PE_codes["BT1201"] += 1;
                                                                                                                                brstart = 0;
                                brend = 0;
                                print1f_types(types, types0, typesbuffer);
                                types0 = "";
                        ...
                        if (success2F == 1) {
                            ...
                            if (TSVu == 1) {
                                types0 = dna_read[0] +  "\tBT\t1011\t" + std::to_string(brstart) + "\t" + std::to_string(brend) + "\n";
                                count_PE_codes["BT1011"] += 1;
                                                                                                                                brstart = 0;
                                brend = 0;
                                print1f_types(types, types0, typesbuffer);
                                types0 = "";
                        ...
                        if (success2R == 1) {
                            ...
                            if (TSVu == 1) {
                                types0 = dna_read[0] +  "\tBT\t1021\t" + std::to_string(brstart) + "\t" + std::to_string(brend) + "\n";
                                count_PE_codes["BT1021"] += 1;
                                                                                                                                brstart = 0;
                                brend = 0;
                                print1f_types(types, types0, typesbuffer);
                                types0 = "";
                    ...
                    if (TSVu == 1) {
                        types0 = read_nb[0] +  "\tBF\t" +  std::to_string(success1F) +  std::to_string(success1R) + std::to_string(success2F) + std::to_string(success2R) + "\t" + std::to_string(brstart) + "\t" + std::to_string(brend) + "\n";
                        count_PE_codes["BF" + std::to_string(success1F) +  std::to_string(success1R) + std::to_string(success2F) + std::to_string(success2R)] += 1;
                                                                                                brstart = 0;
                        brend = 0;
                        print1f_types(types, types0, typesbuffer);
                        types0 = "";
