                    ...
                    if (successf + successr == 1) {
                        if (successf == 1) {
                            if (DNA_Length_Success && RNA_Length_Success) {
                                ...
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tF-DR\t" + std::to_string(last_start) + "\t" + std::to_string(last_end) + "\n";
                            ...
                            if (DNA_Length_Success && !RNA_Length_Success) {
                                ...
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tF-D0\t" +  std::to_string(last_start) + "\t" + std::to_string(last_end) +  "\n";
                            ...
                            if (!DNA_Length_Success && !RNA_Length_Success) {
                                ...
                                if (sepu == 1) print1f_simple(file_nb, read_nb, nbbuffer);
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tF-00\t" +  std::to_string(last_start) + "\t" + std::to_string(last_end) +  "\n";
                ...
                if (success1F + success1R + success2F + success2R == 1) {
                    ...
                    if (RNA_Length_Success && DNA_Length_Success) {
                        if (success1F == 1) {
                            ...
                            if (TSVu == 1) {
                                types0 = dna_read[0] +  "\tF-0-DR\t" + std::to_string(last_start) + "\t" + std::to_string(last_end) + "\n";
                        ...
                        if (success2F == 1) {
                            ...
                            if (TSVu == 1) {
                                types0 = dna_read[0] +  "\t0-F-DR\t" + std::to_string(last_start) + "\t" + std::to_string(last_end) + "\n";
                        ...
                        if (success1F == 1) {
                            ...
                            if (TSVu == 1) {
                                if (DNA_Length_Success && !RNA_Length_Success) {
                                    types0 = dna_read[0] +  "\tF-0-D0"  + std::to_string(last_start) + "\t" + std::to_string(last_end) + "\n";
                                    count_PE_codes["F-0-D0"] += 1;
                                }
                                if (!DNA_Length_Success && RNA_Length_Success) {
                                    types0 = dna_read[0] +  "\tF-0-0R" + std::to_string(last_start) + "\t" + std::to_string(last_end) + "\n";
                                    count_PE_codes["F-0-0R"] += 1;
                                }
                                if (!DNA_Length_Success && !RNA_Length_Success) {
                                    types0 = dna_read[0] +  "\tF-0-00"  + std::to_string(last_start) + "\t" + std::to_string(last_end) + "\n";
                        ...
                        if (success2F == 1) {
                            ...
                            if (TSVu == 1) {
                                if (DNA_Length_Success && !RNA_Length_Success) {
                                    types0 = dna_read[0] +  "\t0-F-D0\t" + std::to_string(last_start) + "\t" + std::to_string(last_end) + "\n";
                                    count_PE_codes["0-F-D0"] += 1;
                                }
                                if (!DNA_Length_Success && RNA_Length_Success) {
                                    types0 = dna_read[0] +  "\t0-F-0R\t" + std::to_string(last_start) + "\t" + std::to_string(last_end) + "\n";
                                    count_PE_codes["0-F-0R"] += 1;
                                }
                                if (!DNA_Length_Success && !RNA_Length_Success) {
                                    types0 = dna_read[0] +  "\t0-F-00\t" + std::to_string(last_start) + "\t" + std::to_string(last_end) + "\n";
