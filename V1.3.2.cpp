                    ...
                    if (successf + successr == 1) {
                        if (successf == 1) {
                            if (DNA_Length_Success && RNA_Length_Success) {
                                ...
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tF-DR\t" + std::to_string(last_start + 1) + "\t" + std::to_string(last_end) + "\t" +  std::to_string(dna_read[1].length()) + "\t" + std::to_string(rna_read[1].length())  + "\n";
                            ...
                            if (DNA_Length_Success && !RNA_Length_Success) {
                                ...
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tF-D0\t" +  std::to_string(last_start + 1) + "\t" + std::to_string(last_end) + "\t" +  std::to_string(dna_read[1].length()) + "\t" + std::to_string(rna_read[1].length()) + "\n";
                            ...
                            if (!DNA_Length_Success && RNA_Length_Success) {
                                ...
                                if (sepu == 1) print1f_simple(file_nb, read_nb, nbbuffer);
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tF-0R\t" +  std::to_string(last_start + 1) + "\t" + std::to_string(last_end) + "\t" +  std::to_string(dna_read[1].length()) + "\t" + std::to_string(rna_read[1].length()) +  "\n";
                            ...
                            if (!DNA_Length_Success && !RNA_Length_Success) {
                                ...
                                if (sepu == 1) print1f_simple(file_nb, read_nb, nbbuffer);
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tF-00\t" +  std::to_string(last_start + 1) + "\t" + std::to_string(last_end) + "\t" +  std::to_string(dna_read[1].length()) + "\t" + std::to_string(rna_read[1].length()) +  "\n";
                            ...
                            if (DNA_Length_Success && RNA_Length_Success) {
                                ...
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tR-DR\t" + std::to_string(one_read[1].size() - brend + 1)  + "\t" +  std::to_string(one_read[1].size() - brstart) + "\t" +  std::to_string(dna_read[1].length()) + "\t" +  std::to_string(rna_read[1].length()) + "\n";
                            ...
                            if (DNA_Length_Success && !RNA_Length_Success) {
                                ...
                                if (sepu == 1) print1f_simple(file_nb, read_nb, nbbuffer);
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tR-D0\t" + std::to_string(one_read[1].size() - brend + 1)  + "\t" +  std::to_string(one_read[1].size() - brstart) + "\t" +  std::to_string(dna_read[1].length()) + "\t" +  std::to_string(rna_read[1].length()) +  "\n";
                            ...
                            if (!DNA_Length_Success && RNA_Length_Success) {
                                ...
                                if (sepu == 1) print1f_simple(file_nb, read_nb, nbbuffer);
                                if (TSVu == 1) {
                                    types0 = dna_read[0] +  "\tR-0R\t" + std::to_string(one_read[1].size() - brend + 1)  + "\t" +  std::to_string(one_read[1].size() - brstart) + "\t" +  std::to_string(dna_read[1].length()) + "\t" + std::to_string(rna_read[1].length()) +  "\n";
                            ...
                            if (!DNA_Length_Success && !RNA_Length_Success) {
                                ...
                                if (sepu == 1) print1f_simple(file_nb, read_nb, nbbuffer);
                                if (TSVu == 1) {
                                    types0 = dna_read[0] + "\tR-00\t" + std::to_string(one_read[1].size() - brend + 1)  + "\t" + std::to_string(one_read[1].size() - brstart) + "\t" +  std::to_string(dna_read[1].length()) + "\t" +  std::to_string(rna_read[1].length()) + "\n";
